 ...
 *                                                                              
 * Initializing the task list involves assigning values to each of the attribut\
es                                                                              
 * of the 'tasklist' structure. You would also have to allocate ,memory for the\
 task                                                                           
 * array.                                                                       
 */
...
tasklist *createAndInitialize()
{
  ...
  pTaskList->task_array = (struct _task**)malloc(sizeof(struct _task*)*pTaskLis\
t->array_size+1);
...
/* addTaskToEnd                                                                 
 *                                                                              
 * This function takes two parameters - the task list and the task to be insert\
ed.                                                                             
 * It attempts to append said task into an array of tasks maintained by the tas\
k                                                                               
 * list. When the array reaches its capacity, the function proceeds to re-alloc\
ate the                                                                         
 * array before carrying out the insertion operation.                           
 *                                                                              
 * NOTE:                                                                        
 * The use of realloc() is NOT permitted in this exercise. You would have to fi\
gure out                                                                        
...
void addTaskToEnd(tasklist *list,task *input_task)
{
  ...
  {
    tasklist *pTaskList = (struct _tasklist*)malloc(sizeof(struct _tasklist)*li\
st->occupied_count+1);
    memcpy(pTaskList,list,sizeof(struct _task*)*list->occupied_count+1);
    pTaskList = list;
...
/* removeTask                                                                   
 *                                                                              
 * This function takes two parameters - the task list and the index value assoc\
iated with                                                                      
 * the task to be removed.                                                      
 *                                                                              
 * The task to be removed can occur anywhere in the task array. You are require\
d to write                                                                      
...
task *removeTask(tasklist *list, int task_index)
{
    ...
    if(task_index <= count)
    {
      list->task_array[task_index] = NULL;
      for(j = task_index; j < count;j++)
      {
...
/* printTaskList                                                                
 *                                                                              
 * This function takes as input the task list and prints the contents of the li\
st on the screen.                                                               
 */
...
void printTaskList(tasklist *list)
{
  ...
  printf("\n The number of occupied entries in the Task List is : %d",
         list->occupied_count);
  printf("\n The size of the Task List is : %d", list->array_size);
